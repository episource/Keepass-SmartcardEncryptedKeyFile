...
## v1.3.0 (2026-02-16)
- Allow to configure smart card worker process bootstrap behavior for enterprise environments with strict threat protection - see [README](https://github.com/episource/Keepass-SmartcardEncryptedKeyFile?tab=readme-ov-file#threat-protection-interference-failed-to-start-unblocker-process-wasnt-ready-within-s---non-default-unblocker-bootstrap-mode) and #4.
...
## v1.1.0 (2025-10-31)
- Fix compatibility with [Win11 2025-10 Update KB5066835](https://learn.microsoft.com/en-us/windows/release-health/resolved-issues-windows-11-25h2#3697msgdesc) (#2)
